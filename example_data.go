...
var messagesA = map[int][]ui.Message{
	0: { // Emma - made longer
...
var messagesB = map[int][]ui.Message{
	0: {
...
var messagesC = map[int][]ui.Message{
	0: {
